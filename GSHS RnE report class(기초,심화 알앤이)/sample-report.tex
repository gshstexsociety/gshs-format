...
% Copyright ⓒ 2015 목진욱(2015학년도 경기과학고 물리과전문교원), 박승원(32nd 학생, 14041), 이상헌(32nd 학생, 14080), Gyeonggi Science HighSchool for the Gifted. All rights reserved. 
% Website : http://gshslatexintro.github.io  본 문서가 컴파일된 pdf를 이곳에서 미리 보실 수 있습니다.
\documentclass{gshs-report-v1.1}
% 추가로 필요한 패키지가 있다면 주석을 풀고 적어넣으십시오,
%\usepackage{...}

%\researchtype{기초} 
\researchtype{심화} % 심화 R&E의 경우 지도교사 외에도 지도교수를 같이 써야 하는데, 여기에서 `심화'로 지정하면 \professor 함수를 사용할 수 있습니다.
\title{보고서 제목}
...
% \professor 지도교수 이름
%researchtype이 '심화' 일 때만 표지에 생성됨
\professor{아무개}

%\summitdate{년}{월}{일}
% @param   year,month,day 연,월,일 순으로 입력
\summitdate{2016}{02}{07}
...
% 버전관리를 할 경우 images 폴더 내의 파일까지도 전부 복사해야 하는 불편함이 있습니다. 이 경우, v1.1, v1.2, v1.3, ... 폴더가 있는 디렉토리에 images 폴더를 만들고,(v1.1, v1.2 내부가 아닌) 다음 함수를 사용하면 됩니다.
%\graphicspath{{../images/}}
...
\item Theorem numbering이 이상하게 됨.(1.0.1,  1.0.2, ...) https://github.com/gshslatexintro/gshslatexintro/issues/7 참조.
