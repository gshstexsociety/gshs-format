...
\documentclass{gshs-report-v0.12}
...
%초록(영문)
\begin{abstract}
Once upon a time, \gshs said : `The first, and the best.'
...
이 gshs-report.cls 파일 혹은 gshs-report-v0.12.cls 파일은 보통의 문서 작성법과는 달리 chapter, section, subsection, subsubsection 이 표 \ref{correlation}와 같이 대응된다. 이유는 알수 없으나 설정이 이렇게 되어 있어서 섣불리 바꾸지를 못하고 있다.
